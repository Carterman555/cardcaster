...
public class PopupCanvas : StaticInstance<PopupCanvas> {
    ...
    public void ActivateUIObject(string name, bool playAudio = true) {
        ...
        currentPopup.RectTransform.anchoredPosition = currentPopup.HidePos;
        currentPopup.RectTransform.DOAnchorPos(currentPopup.ShowPos, 0.3f).SetEase(Ease.OutSine).SetUpdate(true).OnComplete(() => {
