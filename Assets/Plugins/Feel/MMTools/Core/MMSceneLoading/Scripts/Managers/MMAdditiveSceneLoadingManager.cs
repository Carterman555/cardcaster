    ...
    public class MMAdditiveSceneLoadingManager : MMMonoBehaviour {
        ...
        public static void LoadScene(string sceneToLoadName, string loadingSceneName = "MMAdditiveLoadingScreen",
            ...
            if (_loadingInProgress) {
                Debug.LogError($"MMLoadingSceneManagerAdditive : a request to load a new scene was emitted while a scene load was already in progress: {sceneToLoadName}");
                return;
            }
        ...
        protected virtual IEnumerator LoadSequence() {
            ...
            yield return WaitForInterpolateProgress();
        ...
        protected virtual IEnumerator WaitForInterpolateProgress() {
