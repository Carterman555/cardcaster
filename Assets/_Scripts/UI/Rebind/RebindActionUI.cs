    ...
    public class RebindActionUI : MonoBehaviour {
        ...
        public void StartInteractiveRebind() {
            ...
            if (action.bindings[bindingIndex].isComposite) {
                Debug.LogError("Trying to rebind composite binding, but not supported!");
                return;
            }
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex) {
            ...
            RebindPanel.ActiveInstance.DisableNavigation();

            bool usingKeyboardInput = m_playerInput.currentControlScheme == "Keyboard";
            string cancelInput = usingKeyboardInput ? "<Keyboard>/escape" : "<Gamepad>/start";
            ...
            m_RebindOperation = action.PerformInteractiveRebinding(bindingIndex)
                ...
                .OnCancel(
                    operation => {
                        ...
                        RebindPanel.ActiveInstance.EnableNavigation();
                    })
                .OnComplete(
                    operation => {
                        action.Enable();
            ...
            if (RebindPanel.ActiveInstance.RebindingKeyboard) {
                m_RebindOperation
        ...
        [Tooltip("Override text for action label")]
